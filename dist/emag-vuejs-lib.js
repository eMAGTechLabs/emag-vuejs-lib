...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Chosen = __webpack_require__(18);
	...
	var _JqGrid = __webpack_require__(105);
	...
	var _TreeType = __webpack_require__(125);
	
	var _TreeType2 = _interopRequireDefault(_TreeType);
	
	var _Submenu = __webpack_require__(111);
	
	var _Submenu2 = _interopRequireDefault(_Submenu);
	
	var _SidebarControl = __webpack_require__(118);
	...
	var _Datetimepicker = __webpack_require__(137);
	
	var _Datetimepicker2 = _interopRequireDefault(_Datetimepicker);
	
	var _Daterangepicker = __webpack_require__(141);
	
	var _Daterangepicker2 = _interopRequireDefault(_Daterangepicker);
	
	var _HeaderLocaleChild = __webpack_require__(145);
	
	var _HeaderLocaleChild2 = _interopRequireDefault(_HeaderLocaleChild);
	
	var _HeaderNotificationsChild = __webpack_require__(150);
	
	var _HeaderNotificationsChild2 = _interopRequireDefault(_HeaderNotificationsChild);
	
	var _HeaderUserChild = __webpack_require__(156);
	
	var _HeaderUserChild2 = _interopRequireDefault(_HeaderUserChild);
	
	var _LinkItem = __webpack_require__(152);
	...
	var _Chosen3 = __webpack_require__(100);
	
	var _Chosen4 = _interopRequireDefault(_Chosen3);
	
	var _Datetimepicker3 = __webpack_require__(139);
	
	var _Datetimepicker4 = _interopRequireDefault(_Datetimepicker3);
	
	var _Daterangepicker3 = __webpack_require__(143);
	
	var _Daterangepicker4 = _interopRequireDefault(_Daterangepicker3);
	
	var _Header3 = __webpack_require__(147);
	
	var _Header4 = _interopRequireDefault(_Header3);
	
	var _Sidebar3 = __webpack_require__(113);
	
	var _Sidebar4 = _interopRequireDefault(_Sidebar3);
	
	var _TreeType3 = __webpack_require__(127);
	
	var _TreeType4 = _interopRequireDefault(_TreeType3);
	
	var _messages = __webpack_require__(20);
	
	var _messages2 = _interopRequireDefault(_messages);
	
	var _TranslationService = __webpack_require__(162);
	
	var _TranslationService2 = _interopRequireDefault(_TranslationService);
	
	var _AuthService = __webpack_require__(167);
	
	var _AuthService2 = _interopRequireDefault(_AuthService);
	
	var _RoutingService = __webpack_require__(168);
	
	var _RoutingService2 = _interopRequireDefault(_RoutingService);
	
	var _RequestInterceptorService = __webpack_require__(183);
	
	var _RequestInterceptorService2 = _interopRequireDefault(_RequestInterceptorService);
	...
	var EmagVueLib = {
	  ...
	  mixins: {
	    chosen: _Chosen4.default,
	    datetimepicker: _Datetimepicker4.default,
	    daterangepicker: _Daterangepicker4.default,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Chosen = __webpack_require__(100);
	...
	exports.default = {
	  ...
	  computed: {
	    watchProperties: function watchProperties() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _messages_en = __webpack_require__(59);
	
	var _messages_en2 = _interopRequireDefault(_messages_en);
	
	var _messages_ro = __webpack_require__(60);
	
	var _messages_ro2 = _interopRequireDefault(_messages_ro);
	
	var _messages_hu = __webpack_require__(61);
	
	var _messages_hu2 = _interopRequireDefault(_messages_hu);
	
	var _messages_bg = __webpack_require__(62);
	
	var _messages_bg2 = _interopRequireDefault(_messages_bg);
	
	var _messages_pl = __webpack_require__(63);
	
	var _messages_pl2 = _interopRequireDefault(_messages_pl);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.default = {
	  'translations': (0, _assign2.default)(_messages_en2.default, _messages_ro2.default, _messages_bg2.default, _messages_hu2.default, _messages_pl2.default)
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function generateWatchProperties(properties) {
	  ...
	  for (var property in properties) {
	    ...
	    if (typeof properties[property] === 'function' && properties[property] !== null) {
	    ...
	    } else if ((0, _typeof3.default)(properties[property]) === 'object' && properties[property] !== null) {
	      ...
	      for (var _key in properties[property]) {
	        ...
	        if (_key == "colModel") {
	          ...
	          objectPropertyValues.push(_key + ':' + value);
	        }
	      }
	...
	exports.default = {
	  methods: {
	    ...
	    generateWatchProperties: generateWatchProperties,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(29)(IteratorPrototype, __webpack_require__(80)('iterator'), function () { return this; });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _JqGrid = __webpack_require__(107);
	...
	exports.default = {
	  name: 'jqGrid',
	  mixins: [_General2.default, _JqGrid2.default],
	  props: ['dataOptions'],
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  methods: {
	    initJqGrid: initJqGrid,
	    destroyJqGrid: destroyJqGrid
	  }
	};
...
/***/ (function(module, exports) {
	...
	module.exports = "<div :id=\"'wrap_grid_table_' + id\" class=\"\">\n    <table :id=\"'grid_table_' + id\"></table>\n    <div :id=\"'grid_pager_' + id\"></div>\n  </div>";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SidebarItem = __webpack_require__(114);
...
/***/ (function(module, exports) {
	...
	function getItems() {
	  /* eslint-disable no-unused-vars */
	  var items = this.dataOptions && this.dataOptions.items ? this.dataOptions.items : [];
	...
	exports.default = {
	  methods: {
	    getHrefForMenuItem: getHrefForMenuItem,
	    isAbsolute: isAbsolute,
	    hasEmptyLink: hasEmptyLink,
	    getMenuItemCssClass: getMenuItemCssClass,
	    getCollapsedCssClass: getCollapsedCssClass,
	    getItems: getItems
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	hotAPI.install(require("vue"))
	if (!hotAPI.compatible) return
	var id = "-!babel!../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./TreeType.vue"
	hotAPI.createRecord(id, module.exports)
	module.hot.accept(["-!babel!../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./TreeType.vue","-!vue-html-loader!../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./TreeType.vue"], function () {
	var newOptions = require("-!babel!../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./TreeType.vue")
	if (newOptions && newOptions.__esModule) newOptions = newOptions.default
	var newTemplate = require("-!vue-html-loader!../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./TreeType.vue")
	hotAPI.update(id, newOptions, newTemplate)
	})
	})()
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _TreeType = __webpack_require__(127);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Autocomplete = __webpack_require__(131);
	...
	exports.default = {
	  ...
	  mixins: [_General2.default, _Chosen2.default, _Autocomplete2.default],
	  updated: function updated() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Datetimepicker = __webpack_require__(139);
	...
	exports.default = {
	  name: 'datetimepicker',
	  props: ['dataOptions', 'disabled', 'name', 'required'],
	  mixins: [_General2.default, _Datetimepicker2.default],
	  data: function data() {
	    return { options: this.getOptions() };
	  },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	hotAPI.install(require("vue"))
	if (!hotAPI.compatible) return
	var id = "-!babel!../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./Daterangepicker.vue"
	hotAPI.createRecord(id, module.exports)
	module.hot.accept(["-!babel!../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./Daterangepicker.vue","-!vue-html-loader!../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./Daterangepicker.vue"], function () {
	var newOptions = require("-!babel!../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./Daterangepicker.vue")
	if (newOptions && newOptions.__esModule) newOptions = newOptions.default
	var newTemplate = require("-!vue-html-loader!../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./Daterangepicker.vue")
	hotAPI.update(id, newOptions, newTemplate)
	})
	})()
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Daterangepicker = __webpack_require__(143);
	...
	exports.default = {
	  ...
	  props: ['dataOptions', 'disabled', 'name', 'required'],
	  mixins: [_Daterangepicker2.default],
	  data: function data() {
	    return { options: this.getOptions() };
	  },
	  beforeMount: function beforeMount() {
	  ...
	  methods: {
	    ...
	    initDaterangepicker: function initDaterangepicker() {
	      try {
	        ...
	        // attach jquery events on change
	        $picker.on('show.daterangepicker hide.daterangepicker showCalendar.daterangepicker hideCalendar.daterangepicker cancel.daterangepicker apply.daterangepicker', function (event) {
	    ...
	    destroyDaterangepicker: function destroyDaterangepicker() {
	      try {
	        var $picker = $(this.$el).find('#date_range_' + this.id);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	//             <span class="menu-text"><template v-if="isFunction(this.$t) || $t(item.label)">{{ $t(item.label) }}</template><template v-else>{{ item.label }}</template></span>
	//         </a>
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function setLinksForLocales() {
	  ...
	  this.$router.beforeEach(function (to, from, next) {
	    _this2.$set(_this2, 'items', _this2.getLocaleItems());
	    next();
	  });
	}
	...
	exports.default = {
	  methods: {
	    getLocaleItems: getLocaleItems,
	    setDefaultLocale: setDefaultLocale,
	    setLinksForLocales: setLinksForLocales
	  }
	};
...
/***/ (function(module, exports) {
	...
	exports.default = function (Vue, options) {
	  Vue.helpers.getVueRouter().beforeEach(function (to, from, next) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _join = __webpack_require__(169);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(26).Array.join;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * (__webpack_require__(44) != Object || !__webpack_require__(172)(arrayJoin)), 'Array', {
